   ...
   <div class="row"> 
    <div class="col-xs-3 mt60"> 
     <ul class="nav nav-pills nav-stacked"> 
      ...
      <li class="inactive"> <a href="teacherHome.html"> 查看论文 </a> </li> 
      <li class="text-muted"> <h3>个人信息</h3> </li> 
      <li class="active"><a href="teacherInfo.html">个人主页</a></li> 
      <li class="inactive"><a href="teacherPassword.html">修改密码</a></li> 
     </ul> 
    </div> 
